...
<section class="py-16 bg-base-200">
	<div class="container-custom">
		<h2 class="text-5xl lg:text-7xl font-bold text-center">ABOUT IMPACTOLOGY</h2>
	</div>
</section>
...
<section class="py-16 bg-base-100">
	<div class="container-custom">
		...
		<div class="text-center mt-16">
			<a href="#connect" class="btn btn-secondary btn-lg uppercase font-bold mt-8">
				CONNECT WITH US
			</a>
		</div>
	</div>
...
<section class="py-20 md:py-28 bg-base-100">
	<div class="container-custom">
		<h2 class="text-5xl lg:text-7xl font-bold text-center mb-16">OUR FOUNDER</h2>
...
<section class="py-20 bg-base-200" id="connect">
	<div class="container-custom">
		<div class="max-w-3xl mx-auto">
			<h2 class="text-5xl lg:text-7xl font-bold text-center mb-12">CONNECT WITH US</h2>
